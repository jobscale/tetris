/* eslint-env browser */
/* eslint-disable no-multi-assign, prefer-destructuring, func-names */
...
Page.ScoreBarHigh = new DrawAreaObj(10.5, 0, 4.5, 1, function () {
  ...
  const miniUnit = Page.unitSize * 0.01;
...
Page.ScoreBarCur = new DrawAreaObj(10.5, 1.1, 4.5, 1, function () {
  ...
  let text; let left; let top; let size;
  const miniUnit = Page.unitSize * 0.01;
...
window.addEventListener('DOMContentLoaded', () => {
  Init();
  Loop();
  window.onresize = Page.WindowChanged;
